package ca.sheridancollege.yoojiw.services;
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		ca.sheridancollege.yoojiw.beans.User user = da.findUserAccount(username);		//
		...
		UserDetails userDetails = (UserDetails) new User(user.getEmail(), user.getEncryptedPassword(), grantList);		//grantList
			return userDetails;
	}
